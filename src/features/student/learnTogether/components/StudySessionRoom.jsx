                  ...
                  <div className="flex flex-col gap-2">
                    {LAYOUT_OPTIONS.map((opt) => (
                      <button
                        ...
                        onClick={() => {
                          setLayoutModeWithLog(opt.value);
          ...
          {(() => {
            ...
            if (layoutMode === "spotlight" && pinnedParticipantId) {
              ...
              const others = [
                ...
                ...(!participants.some((p) => p.user_id === userId) && pinnedParticipantId !== `user_${userId}`
                  ? [
                      {
                        id: `user_${userId}`,
                        user_id: userId,
            ...
            if (layoutMode === "speaker") {
              ...
              const others = [
                ...
                ...(!participants.some((p) => p.user_id === userId) && speakerId !== userId
                  ? [
                      {
                        id: `user_${userId}`,
                        user_id: userId,
                  ...
                  >
                    ...
                    >
                      ...
                      {!tile.muted && !tile.isScreen && (
                        <SpeakingIndicator isActive={speakingParticipants.has(tile.user_id)} audioLevel={50} />
                      )}
                    </div>
                  </div>
                ))}

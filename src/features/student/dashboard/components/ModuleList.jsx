...
const ModuleList = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-md" title="Browse all modules. Pre/Post badges help you track which tests you’ve completed.">
      <h2 className="text-2xl font-bold text-primary-dark mb-4" title="Your available modules and their test status (pre/post).">
        Your Modules
      </h2>

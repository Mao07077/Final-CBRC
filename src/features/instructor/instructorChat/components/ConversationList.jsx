...
const ConversationList = () => {
  ...
  {Object.entries(conversations).map(([id, convo]) => {
          ...
          // Compose last message preview using WebSocket messages too
          ...
          return (
            ...
            >
              ...
              <p className="text-sm text-gray-600 truncate">{last ? last.message : "No messages yet"}</p>
            </li>
          );
        })}
      </ul>

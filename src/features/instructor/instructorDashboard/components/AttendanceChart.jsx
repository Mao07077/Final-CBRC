...
const AttendanceChart = ({ data, isLoading }) => {
  ...
  <div className="flex items-center gap-2 mb-2">
    <h3 className="text-xl font-bold text-primary-dark">Attendance & Study Hours (Last 7 days)</h3>
    <InfoTooltip text="Days present (≥ 0.5h/day) and the total study hours aggregated across students for the last 7 days." />
  </div>
